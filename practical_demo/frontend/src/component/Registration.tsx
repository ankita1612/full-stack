...
import registrationValidate from "../validations/registration.validations";
import type { registrationInterface } from "../interfaces/registrations.interface";
...
const Registration = () => {
  ...
  const onSubmit = async (data: registrationInterface) => {
    try {
      data.status = "active";
      const result = await apiClient.post("/api/auth/registration", data);
